...
def author():
    return 'zzheng309'  # replace gburdell3 with your Georgia Tech username.


def gtid():
    return 903546508  # replace with your GT ID number
    ...
    def run_pagerank(self, node_weights, damping_factor=0.85, iterations=10):
        ...
        for it in range(iterations):
            ...
            for i in range(len(new_scores)):
                new_scores[i] += (1 - damping_factor) * node_weights[i]
            scores = new_scores
            # pass
        #############################################
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description='sample command:  python pagerank.py -i 5 -d 0.85 simplified_pagerank soc-wiki-elec.edges')
    ...
    if args.command == 'simplified_pagerank':
        ...
        result = pr.run_pagerank(node_weights=node_weights, iterations=args.iterations,
